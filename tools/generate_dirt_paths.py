...
Shared-edge preparation is delegated to ground_tile_worker.py so future ground
materials can reuse the same seam pipeline.
"""
...
def preview(tiles: dict[int, Image.Image], path: Path) -> None:
    # No grid overlay: this preview is a visual seam gate.
