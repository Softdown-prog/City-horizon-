...
3. **Limpeza de borda** — remover bevel/rim e contaminação somente no perímetro. Nunca espalhar correção para o centro.
...
6. **Gates** — validar contrato geométrico e métricas técnicas.
...
8. **Runtime** — só classificar como asset aprovado depois do preview visual.
