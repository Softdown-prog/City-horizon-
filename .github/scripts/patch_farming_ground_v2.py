...
replacement = '''void MapRenderer::render_farming(SDL_Renderer* renderer, const FarmingSystem& farming, const CropCatalog& crops,
...
if count != 1:
    raise SystemExit(f"Expected exactly one legacy render_farming block, replaced {count}")
